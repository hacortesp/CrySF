...
def parse_args():
    ...
    parser.add_argument('-nts'    ,  type = float, default= 0.25, help='Time interval between frames in VoxelIndices.dat (-ts * -tts)')
    ...
    parser.add_argument('-deltf'  ,  type = int,   default = 2, help='Eevery how many frames the trajectory is used to calculate the jump coeficient, simultaneous jumps.')
